...
// EVENT HANDLERS
 ...
 JphUtil_Touches.prototype._OnTouchMove		=	function( e)
 {
	...
	if (e.touches.length == 2)
	{
		var touch = e.touches[0];
                ...
                node.style.left = touch.pageX - this.mOriginalX + "px";
                node.style.top = touch.pageY - this.mOriginalY + "px";
		this.mMoving    =       false;
                this.mTouching  =       true;
	}
 ...
 JphUtil_Touches.prototype._OnGestureChange = function( e)
 {
	...
	{
		e.target.style.webkitTransform = "scale(" + e.scale * this.mScale + ")";
	}
 }

 JphUtil_Touches.prototype._OnGestureEnd = function( e)
 {
        if (e.currentTarget.id == "slider-container")
        {
